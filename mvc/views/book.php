                    ...
                    <div class="col-md-8 col-12">
                        ...
                        <div class='content'>
                            ...
                            <div class="star">
                                ...
                                <span class="star__report"><a href='/feedback/stadium/<?= $data['stadium']->id ?>'>(
                                        Xem đánh giá
                                        )</a></span>
                            </div>
                        ...
                        <div class="description">
                            <div class="time">
                                ...
                                <div class="search-time-yard">
                                    ...
                                    <input type="date" value='<?php echo date('Y-m-d'); ?>' name="booking-yard-day" id="date-booking-yard-day" data-id="<?php echo $data['stadium']->id; ?>">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class='booking__input'>
                                            ...
                                            <input required value='18:00:00' name='hour-booking' id="hour-booking" type="time">
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class='booking__input'>
                                            ...
                                            <div>
                                                <div class="model-auth__bill--decs">
                                                    <div class="wrap-detai">
                                                        <h3>Sân bóng:</h3>
                                                        <span id='model__name__yard'><?php echo $data['stadium']->name ?></span>
                                                    </div>
                                                    <div class="wrap-detai">
                                                        <h3>Địa chỉ:</h3>
