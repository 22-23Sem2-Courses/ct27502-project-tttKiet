                ...
                <div class='container'>
                    <div class='row g-5'>
                        <div class="col-md-8 col-12">
                            <div class="image">
                                <img src="<?=  $data['stadium']->imgLink ?>" alt="">
                            </div>

                            <div class='content'>
                                <div class='pt-4'>
                                    <h1 class="title"><?=  $data['stadium'] -> name ?></h1>
                                </div>
                                ...
                                <div class="star">
                                    ...
                                    <span class="star__report">
                                        <a href='/feedback/stadium/<?= $data['stadium']->id ?>'>(
                                            Xem đánh giá
                                            )
                                        </a>
                                    </span>
