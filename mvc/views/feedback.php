                ...
                <?php foreach ($data['stadiums'] as $stadium) : ?>
                    <div class="row feedback-row py-3">
                                    ...
                                    <div class="row">
                                        <div class="col pt-1">
                                            <div class="star-review list-group-item">
                                                ...
                                                <?php for ($i = 0; $i < $data['allRating'][$stadium['id']]; $i++) : ?>
                        ...
                        <div class="col-12 col-lg-7 user-feedback">
                            <div class="row pt-2">
                                <h2 class="feedback-title text-center ">Một số đánh giá của các cầu thủ về
                            ...
                            if (count($feedbacks) <= 0) {
                                ...
                                <h3 class="text-center text-light  w-50 bg-success py-3 shadow-lg rounded feedback-title">Sân này hiện tại chưa có đánh giá nào</h3>
                            </div>
                    ';
                            } else {
