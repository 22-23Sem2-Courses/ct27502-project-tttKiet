...
<html lang="en">
    ...
    <body>
        ...
        <main id="main">
            <div class="container">
                <div class="profit">
                    <h1 class="title">Lợi ích khi sử dụng FOOTBALL - ORDER</h1>
                    <div class="profit__list row">
                        <div class="col-md-3 col-sm-12 profit__list--item">
                            <i class="fa-solid fa-check"></i>
                            <div>
                                <h2>Dễ dàng tìm kiếm sân bóng</h2>
                                <span>Trang web cung cấp cho bạn thông tin chi tiết về các sân bóng hiện có, giúp bạn dễ
                        ...
                        <div class="col-md-3 col-sm-12 profit__list--item">
                            ...
                            <div>
                                ...
                                <span>Bạn có thể xem giá sân bóng đá trực tuyến, giúp bạn đặt sân với giá tốt nhất và
                        ...
                        <div class="col-md-3 col-sm-12 profit__list--item">
                            ...
                            <div>
                                ...
                                <span>Bạn không cần phải đến trực tiếp sân bóng để đặt sân, mà chỉ cần truy cập trang
                        ...
                        <div class="col-md-3 col-sm-12 profit__list--item">
                            ...
                            <span>Trang web sẽ cung cấp cho bạn các thông tin chi tiết về sân bóng, giúp bạn lựa chọn
